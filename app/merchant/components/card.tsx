          ...
          <div className="px-2 pb-5">
            <div className="flex items-center justify-between">
              ...
              <div className="flex justify-end">
                <Link
                  className="mx-1 text-white bg-blue-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2.5 text-center"
                  href="/post/[id]"
                  as={`/post/${title + time}`}
                >
                  <svg
